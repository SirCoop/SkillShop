!function() {
    ...
    (function() {
        ...
        _.map = _.collect = function(obj, iteratee, context) {
            ...
            for (var currentKey, keys = obj.length !== +obj.length && _.keys(obj), length = (keys || obj).length, results = Array(length), index = 0; length > index; index++) {
        ...
        _.shuffle = function(obj) {
            for (var rand, set = obj && obj.length === +obj.length ? obj : _.values(obj), length = set.length, shuffled = Array(length), index = 0; length > index; index++) {
        ...
        _.uniq = _.unique = function(array, isSorted, iteratee, context) {
            ...
            for (var result = [], seen = [], i = 0, length = array.length; length > i; i++) {
                var value = array[i];
                if (isSorted) {
                    i && seen === value || result.push(value);
                    seen = value;
                } else if (iteratee) {
        ...
        _.lastIndexOf = function(array, item, from) {
            ...
            "number" == typeof from && (idx = 0 > from ? idx + from + 1 : Math.min(idx, from + 1));
        ...
        _.before = function(times, func) {
            var memo;
            return function() {
                --times > 0 ? memo = func.apply(this, arguments) : func = null;
                return memo;
            };
        };
    ...
    !function(window, undefined) {
        ...
        function addToPrefiltersOrTransports(structure) {
            return function(dataTypeExpression, func) {
                ...
                if (jQuery.isFunction(func)) for (;dataType = dataTypes[i++]; ) if ("+" === dataType[0]) {
        ...
        jQuery.fn.extend({
            ...
            toggleClass: function(value, stateVal) {
                ...
                return this.each(jQuery.isFunction(value) ? function(i) {
                    ...
                    if ("string" === type) for (var className, i = 0, self = jQuery(this), state = stateVal, classNames = value.match(core_rnotwhite) || []; className = classNames[i++]; ) {
            ...
            trigger: function(event, data, elem, onlyHandlers) {
                ...
                if (3 !== elem.nodeType && 8 !== elem.nodeType && !rfocusMorph.test(type + jQuery.event.triggered)) {
                    ...
                    if (onlyHandlers || !special.trigger || special.trigger.apply(elem, data) !== !1) {
                        ...
                        event.type = type;
                        if (!(onlyHandlers || event.isDefaultPrevented() || special._default && special._default.apply(elem.ownerDocument, data) !== !1 || "click" === type && jQuery.nodeName(elem, "a") || !jQuery.acceptData(elem) || !ontype || !elem[type] || jQuery.isWindow(elem))) {
                            tmp = elem[ontype];
                ...
                if (!special.preDispatch || special.preDispatch.call(this, event) !== !1) {
                    ...
                    for (;(matched = handlerQueue[i++]) && !event.isPropagationStopped(); ) {
                        ...
                        for (;(handleObj = matched.handlers[j++]) && !event.isImmediatePropagationStopped(); ) if (!event.namespace_re || event.namespace_re.test(handleObj.namespace)) {
                            ...
                            if (ret !== undefined && (event.result = ret) === !1) {
        ...
        !function(window, undefined) {
            ...
            setDocument = Sizzle.setDocument = function(node) {
                ...
                sortOrder = docElem.compareDocumentPosition ? function(a, b) {
                    ...
                    return (compare = b.compareDocumentPosition && a.compareDocumentPosition && a.compareDocumentPosition(b)) ? 1 & compare || a.parentNode && 11 === a.parentNode.nodeType ? a === doc || contains(preferredDoc, a) ? -1 : b === doc || contains(preferredDoc, b) ? 1 : 0 : 4 & compare ? -1 : 1 : a.compareDocumentPosition ? -1 : 1;
                } : function(a, b) {
            ...
            Expr = Sizzle.selectors = {
                ...
                preFilter: {
                    ...
                    PSEUDO: function(match) {
                        ...
                        if (match[4]) match[2] = match[4]; else if (unquoted && rpseudo.test(unquoted) && (excess = tokenize(unquoted, !0)) && (excess = unquoted.indexOf(")", unquoted.length - excess) - unquoted.length)) {
                ...
                filter: {
                    ...
                    ATTR: function(name, operator, check) {
                        return function(elem) {
                            ...
                            result += "";
                            return "=" === operator ? result === check : "!=" === operator ? result !== check : "^=" === operator ? check && 0 === result.indexOf(check) : "*=" === operator ? check && result.indexOf(check) > -1 : "$=" === operator ? check && result.slice(-check.length) === check : "~=" === operator ? (" " + result + " ").indexOf(check) > -1 : "|=" === operator ? result === check || result.slice(0, check.length + 1) === check + "-" : !1;
                        };
                    },
        ...
        jQuery.fn.extend({
            ...
            remove: function(selector, keepData) {
                for (var elem, i = 0; null != (elem = this[i]); i++) if (!selector || jQuery.filter(selector, [ elem ]).length > 0) {
        ...
        jQuery.extend({
            clone: function(elem, dataAndEvents, deepDataAndEvents) {
                ...
                if (jQuery.support.html5Clone || jQuery.isXMLDoc(elem) || !rnoshimcache.test("<" + elem.nodeName + ">")) clone = elem.cloneNode(!0); else {
            ...
            cleanData: function(elems, acceptData) {
                for (var elem, type, id, data, i = 0, internalKey = jQuery.expando, cache = jQuery.cache, deleteExpando = jQuery.support.deleteExpando, special = jQuery.event.special; null != (elem = elems[i]); i++) if (acceptData || jQuery.acceptData(elem)) {
                    id = elem[internalKey];
                    data = id && cache[id];
                    if (data) {
    ...
    !function(root, factory) {
        if ("function" == typeof define && define.amd) define("backbone", [ "underscore", "jquery", "exports" ], function(_, $, exports) {
            ...
            off: function(name, callback, context) {
                ...
                for (i = 0, l = names.length; l > i; i++) {
                    ...
                    if (events = this._events[name]) {
                        ...
                        if (callback || context) for (j = 0, k = events.length; k > j; j++) {
                            ev = events[j];
        ...
        _.extend(Collection.prototype, Events, {
            ...
            set: function(models, options) {
                ...
                if (toAdd.length || order && order.length) {
                    ...
                    if (null != at) for (i = 0, l = toAdd.length; l > i; i++) this.models.splice(at + i, 0, toAdd[i]); else {
    ...
    !function(root, factory) {
        if ("function" == typeof define && define.amd) define("marionette", [ "backbone", "underscore" ], function(Backbone, _) {
        ...
        Marionette.getOption = function(target, optionName) {
            if (target && optionName) {
                var value;
                value = target.options && void 0 !== target.options[optionName] ? target.options[optionName] : target[optionName];
                return value;
            }
        };
        ...
        Marionette.triggerMethod = function() {
            ...
            var splitter = /(^|:)(\w)/gi, triggerMethod = function(event) {
                ...
                _.isFunction(method) && (result = method.apply(this, _.tail(arguments)));
                _.isFunction(this.trigger) && this.trigger.apply(this, arguments);
                return result;
            };
        ...
        !function(Marionette) {
            ...
            function iterateEvents(target, entity, bindings, functionCallback, stringCallback) {
                if (entity && bindings) {
                    _.isFunction(bindings) && (bindings = bindings.call(target));
        ...
        Marionette.Region = function(options) {
            ...
            this.el || throwError('An "el" must be specified for a region.', "NoElError");
        ...
        _.extend(Marionette.Region, {
            buildRegion: function(regionConfig, defaultRegionClass) {
                var regionIsString = _.isString(regionConfig), regionSelectorIsString = _.isString(regionConfig.selector), regionClassIsUndefined = _.isUndefined(regionConfig.regionClass), regionIsClass = _.isFunction(regionConfig);
                regionIsClass || regionIsString || regionSelectorIsString || throwError("Region must be specified as a Region class,a selector string or an object with selector property");
                var selector, RegionClass;
                regionIsString && (selector = regionConfig);
                if (regionConfig.selector) {
                    selector = regionConfig.selector;
                    delete regionConfig.selector;
                }
                regionIsClass && (RegionClass = regionConfig);
                !regionIsClass && regionClassIsUndefined && (RegionClass = defaultRegionClass);
                if (regionConfig.regionClass) {
                    RegionClass = regionConfig.regionClass;
                    delete regionConfig.regionClass;
                }
                (regionIsString || regionIsClass) && (regionConfig = {});
                regionConfig.el = selector;
                var region = new RegionClass(regionConfig);
                regionConfig.parentEl && (region.getEl = function(el) {
                    if (_.isObject(el)) return Backbone.$(el);
                    var parentEl = regionConfig.parentEl;
                    _.isFunction(parentEl) && (parentEl = parentEl());
        ...
        _.extend(Marionette.Region.prototype, Backbone.Events, {
            show: function(view, options) {
                ...
                if (_shouldShowView) {
                    view.render();
                    isChangingView && this.triggerMethod("before:swap", view);
                    this.triggerMethod("before:show", view);
                    this.triggerMethod.call(view, "before:show");
                    this.attachHtml(view);
                    this.currentView = view;
                    isChangingView && this.triggerMethod("swap", view);
                    this.triggerMethod("show", view);
                    _.isFunction(view.triggerMethod) ? view.triggerMethod("show") : this.triggerMethod.call(view, "show");
                    return this;
                }
                return this;
            },
        ...
        Marionette.RegionManager = function(Marionette) {
            var RegionManager = Marionette.Controller.extend({
                ...
                addRegion: function(name, definition) {
                    ...
                    region = isString || isObject && hasSelector ? Marionette.Region.buildRegion(definition, Marionette.Region) : _.isFunction(definition) ? Marionette.Region.buildRegion(definition, Marionette.Region) : definition;
        ...
        _.extend(Marionette.TemplateCache.prototype, {
            ...
            loadTemplate: function(templateId) {
                ...
                template && 0 !== template.length || throwError('Could not find template: "' + templateId + '"', "NoTemplateError");
                return template;
            },
        ...
        Marionette.Renderer = {
            render: function(template, data) {
                ...
                var templateFunc;
                templateFunc = "function" == typeof template ? template : Marionette.TemplateCache.get(template);
        ...
        Marionette.View = Backbone.View.extend({
            constructor: function(options) {
                ...
                _.isObject(this.behaviors) && new Marionette.Behaviors(this);
            ...
            mixinTemplateHelpers: function(target) {
                ...
                _.isFunction(templateHelpers) && (templateHelpers = templateHelpers.call(this));
            ...
            _delegateDOMEvents: function(events) {
                ...
                _.isFunction(events) && (events = events.call(this));
        ...
        Marionette.ItemView = Marionette.View.extend({
            ...
            serializeData: function() {
                var data = {};
                this.model ? data = this.model.toJSON() : this.collection && (data = {
            ...
            destroy: function() {
                this.isDestroyed || Marionette.View.prototype.destroy.apply(this, arguments);
            }
        });
        Marionette.CollectionView = Marionette.View.extend({
            ...
            constructor: function(options) {
                ...
                this.sort = _.isUndefined(initOptions.sort) ? !0 : initOptions.sort;
            ...
            _sortViews: function() {
                ...
                orderChanged && this.render();
            },
            _renderChildren: function() {
                this.startBuffering();
                this.destroyEmptyView();
                this.destroyChildren();
                if (this.isEmpty(this.collection)) this.showEmptyView(); else {
            ...
            addEmptyView: function(child, EmptyView) {
                ...
                this._isShown && this.triggerMethod.call(view, "before:show");
                this.children.add(view);
                this.renderChildView(view, -1);
                this._isShown && this.triggerMethod.call(view, "show");
            },
            getChildView: function() {
                var childView = this.getOption("childView");
                childView || throwError('A "childView" must be specified', "NoChildViewError");
                return childView;
            },
            ...
            _updateIndices: function(view, increment, index) {
                if (this.sort) if (increment) {
                    view._index = index;
                    this.children.each(function(laterView) {
                        laterView._index >= view._index && laterView._index++;
                    });
                } else this.children.each(function(laterView) {
                    laterView._index >= view._index && laterView._index--;
                });
            },
            _addChildView: function(view, index) {
                ...
                this._isShown && !this.isBuffering && (_.isFunction(view.triggerMethod) ? view.triggerMethod("show") : Marionette.triggerMethod.call(view, "show"));
            ...
            proxyChildEvents: function(view) {
                ...
                this.listenTo(view, "all", function() {
                    var args = Array.prototype.slice.call(arguments), rootEvent = args[0], childEvents = this.normalizeMethods(_.result(this, "childEvents"));
        ...
        Marionette.CompositeView = Marionette.CollectionView.extend({
            ...
            serializeData: function() {
                var data = {};
                this.model && (data = this.model.toJSON());
                return data;
            },
            render: function() {
                this._ensureViewIsIntact();
        ...
        Marionette.LayoutView = Marionette.ItemView.extend({
            ...
            _initializeRegions: function(options) {
                ...
                regions = _.isFunction(this.regions) ? this.regions(options) : this.regions || {};
        ...
        Marionette.Behaviors = function(Marionette, _) {
            function Behaviors(view, behaviors) {
                ...
                Behaviors.wrap(view, behaviors, [ "bindUIElements", "unbindUIElements", "delegateEvents", "undelegateEvents", "behaviorEvents", "triggerMethod", "setElement", "destroy" ]);
            }
            var methods = {
