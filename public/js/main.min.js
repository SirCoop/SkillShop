!function() {
    !function(a, b) {
        ...
        var s = function(a) {
                ...
                return d && !d[u] && (d = vb(d)), e && !e[u] && (e = vb(e, f)), hb(function(f, g, h, i) {
                    ...
                    if (f) {
                        if (e || a) {
                            ...
                            k = r.length;
                            for (;k--; ) (l = r[k]) && (j = e ? K.call(f, l) : m[k]) > -1 && (f[j] = !(g[j] = l));
                        }
            ...
            return h = fb.compile = function(a, b) {
                ...
                if (!f) {
                    b || (b = g(a)), c = b.length;
                    for (;c--; ) f = wb(b[c]), f[u] ? d.push(f) : e.push(f);
                ...
                if (e = e || [], 1 === o.length) {
                    ...
                    for (;i-- && (k = j[i], !d.relative[l = k.type]); ) if ((m = d.find[l]) && (f = m(k.matches[0].replace(cb, db), ab.test(j[0].type) && ob(b.parentNode) || b))) {
    ...
    !function(a, b) {
        if ("function" == typeof define && define.amd) define("marionette", [ "backbone", "underscore" ], function(c, d) {
            return a.Marionette = b(a, c, d);
        }); else if ("undefined" != typeof exports) {
            var c = require("backbone"), d = require("underscore");
            module.exports = b(a, c, d);
        } else a.Marionette = b(a, a.Backbone, a._);
    }(this, function(a, b, c) {
        !function(a, b) {
        ...
        var d = a.Marionette, e = b.Marionette = {};
        e.VERSION = "2.2.0", e.noConflict = function() {
            return a.Marionette = d, this;
        }, b.Marionette = e, e.Deferred = b.$.Deferred;
        var f = Array.prototype.slice;
        e.extend = b.Model.extend, e.getOption = function(a, b) {
            if (a && b) {
                var c;
                return c = a.options && void 0 !== a.options[b] ? a.options[b] : a[b];
            }
        }, e.proxyGetOption = function(a) {
            return e.getOption(this, a);
        }, e.normalizeMethods = function(a) {
            var b = {};
            return c.each(a, function(a, d) {
                c.isFunction(a) || (a = this[a]), a && (b[d] = a);
            }, this), b;
        }, e.normalizeUIString = function(a, b) {
            return a.replace(/@ui\.[a-zA-Z_$0-9]*/g, function(a) {
                return b[a.slice(4)];
            });
        }, e.normalizeUIKeys = function(a, b) {
            return "undefined" != typeof a ? (a = c.clone(a), c.each(c.keys(a), function(c) {
                var d = e.normalizeUIString(c, b);
                d !== c && (a[d] = a[c], delete a[c]);
            }), a) : void 0;
        }, e.normalizeUIValues = function(a, b) {
            return "undefined" != typeof a ? (c.each(a, function(d, f) {
                c.isString(d) && (a[f] = e.normalizeUIString(d, b));
            }), a) : void 0;
        ...
        }, e.triggerMethod = function(a) {
            function b(a, b, c) {
                return c.toUpperCase();
            }
            var d, e = /(^|:)(\w)/gi, f = "on" + a.replace(e, b), g = this[f];
            return c.isFunction(g) && (d = g.apply(this, c.tail(arguments))), c.isFunction(this.trigger) && this.trigger.apply(this, arguments), 
            d;
        }, e.triggerMethodOn = function(a, b) {
            var d, f = c.tail(arguments, 2);
            return d = c.isFunction(a.triggerMethod) ? a.triggerMethod : e.triggerMethod, d.apply(a, [ b ].concat(f));
            ...
            function f(a) {
                a._isShown && a._isRendered && g(a) && c.isFunction(a.triggerMethod) && a.triggerMethod("dom:refresh");
            }
            function g(c) {
                return b.$.contains(a, c.el);
            }
            return function(a) {
        ...
        var g = [ "description", "fileName", "lineNumber", "name", "message", "number" ];
        return e.Error = e.extend.call(Error, {
            urlRoot: "http://marionettejs.com/docs/" + e.VERSION + "/",
            constructor: function(a, b) {
                c.isObject(a) ? (b = a, a = b.message) : b || (b = {});
                var d = Error.call(this, a);
                c.extend(this, c.pick(d, g), c.pick(b, g)), this.captureStackTrace(), b.url && (this.url = this.urlRoot + b.url);
            },
            ...
            destroy: function() {
                ...
                return this.triggerMethod.apply(this, [ "before:destroy" ].concat(a)), this.triggerMethod.apply(this, [ "destroy" ].concat(a)), 
        ...
        }, e.Object.extend = e.extend, c.extend(e.Object.prototype, {
            initialize: function() {},
            destroy: function() {
            ...
            _buildRegionFromObject: function(a, d) {
                var e = a.regionClass || d, f = c.omit(a, "selector", "regionClass");
            ...
            show: function(a, b) {
                this._ensureElement();
                var d = b || {}, f = a !== this.currentView, g = !!d.preventDestroy, h = !!d.forceShow, i = !!this.currentView, j = !g && f, k = f || h;
                return i && this.triggerMethod("before:swapOut", this.currentView), j && this.empty(), 
                k ? (a.once("destroy", c.bind(this.empty, this)), a.render(), i && this.triggerMethod("before:swap", a), 
                this.triggerMethod("before:show", a), e.triggerMethodOn(a, "before:show"), i && this.triggerMethod("swapOut", this.currentView), 
                this.attachHtml(a), this.currentView = a, i && this.triggerMethod("swap", a), this.triggerMethod("show", a), 
                e.triggerMethodOn(a, "show"), this) : this;
            },
            _ensureElement: function() {
                if (c.isObject(this.el) || (this.$el = this.getEl(this.el), this.el = this.$el[0]), 
                !this.$el || 0 === this.$el.length) throw new e.Error('An "el" ' + this.$el.selector + " must exist in DOM");
            },
            getEl: function(a) {
                return b.$(a);
            },
            attachHtml: function(a) {
                this.el.innerHTML = "", this.el.appendChild(a.el);
            },
            empty: function() {
                var a = this.currentView;
                return a ? (this.triggerMethod("before:empty", a), this._destroyView(), this.triggerMethod("empty", a), 
                delete this.currentView, this) : void 0;
            },
            _destroyView: function() {
                var a = this.currentView;
                a.destroy && !a.isDestroyed ? a.destroy() : a.remove && a.remove();
            },
            ...
            var b = a.Controller.extend({
                constructor: function(b) {
                    this._regions = {}, a.Controller.call(this, b);
                },
                ...
                addRegion: function(b, c) {
                    var d;
                    return d = c instanceof a.Region ? c : a.Region.buildRegion(c, a.Region), this.triggerMethod("before:add:region", b, d), 
                    this._store(b, d), this.triggerMethod("add:region", b, d), d;
                },
                get: function(a) {
                ...
                destroy: function() {
                    return this.removeRegions(), a.Controller.prototype.destroy.apply(this, arguments);
                },
                _store: function(a, b) {
                ...
                _remove: function(a, b) {
                    ...
                    delete this._regions[a], this._setLength(), this.triggerMethod("remove:region", a, b);
                },
                _setLength: function() {
            ...
            loadTemplate: function(a) {
                var c = b.$(a).html();
                if (!c || 0 === c.length) throw new e.Error({
            ...
            constructor: function(a) {
                c.bindAll(this, "render"), this.options = c.extend({}, c.result(this, "options"), c.isFunction(a) ? a.call(this) : a), 
                this._behaviors = e.Behaviors(this), b.View.apply(this, arguments), e.MonitorDOMRefresh(this), 
            ...
            serializeModel: function(a) {
                return a.toJSON.apply(a, f.call(arguments, 1));
            },
            ...
            normalizeUIKeys: function(a) {
                var b = c.result(this, "ui"), d = c.result(this, "_uiBindings");
                return e.normalizeUIKeys(a, d || b);
            },
            normalizeUIValues: function(a) {
                var b = c.result(this, "ui"), d = c.result(this, "_uiBindings");
                return e.normalizeUIValues(a, d || b);
            },
            configureTriggers: function() {
                if (this.triggers) {
                    var a = {}, b = this.normalizeUIKeys(c.result(this, "triggers"));
                    return c.each(b, function(b, c) {
                        a[c] = this._buildViewTrigger(b);
                    }, this), a;
                }
            },
            ...
            _delegateDOMEvents: function(a) {
                ...
                var e = {}, f = c.result(this, "behaviorEvents") || {}, g = this.configureTriggers(), h = c.result(this, "behaviorTriggers") || {};
                c.extend(e, f, d, g, h), b.View.prototype.delegateEvents.call(this, e);
            },
            undelegateEvents: function() {
                var a = f.call(arguments);
                return b.View.prototype.undelegateEvents.apply(this, a), this.unbindEntityEvents(this.model, this.getOption("modelEvents")), 
            ...
            destroy: function() {
                if (!this.isDestroyed) {
                    ...
                    this.remove(), c.invoke(this._behaviors, "destroy", a), this;
                }
            },
            ...
            triggerMethod: function() {
                var a = arguments, b = e.triggerMethod, d = b.apply(this, a);
                return c.each(this._behaviors, function(c) {
                    b.apply(c, a);
                }), d;
            },
            ...
            serializeData: function() {
                var a = {};
                return this.model ? a = c.partial(this.serializeModel, this.model).apply(this, arguments) : this.collection && (a = {
                    items: c.partial(this.serializeCollection, this.collection).apply(this, arguments)
                }), a;
            },
            ...
            _renderTemplate: function() {
                ...
                if (a !== !1) {
                    ...
                    var c = e.Renderer.render(a, b, this);
            ...
            destroy: function() {
                return this.isDestroyed ? void 0 : e.View.prototype.destroy.apply(this, arguments);
            }
        }), e.CollectionView = e.View.extend({
            childViewEventPrefix: "childview",
            constructor: function(a) {
                var d = a || {};
                if (this.sort = c.isUndefined(d.sort) ? !0 : d.sort, d.collection && !(d.collection instanceof b.Collection)) throw new e.Error("The Collection option passed to this view needs to be an instance of a Backbone.Collection");
                this.once("render", this._initialEvents), this._initChildViewStorage(), e.View.apply(this, arguments), 
            ...
            _onCollectionAdd: function(a) {
                ...
                var b = this.getChildView(a), c = this.collection.indexOf(a);
                this.addChild(a, b, c);
            },
            ...
            addEmptyView: function(a, b) {
                ...
                c.isFunction(d) && (d = d.call(this));
                var f = this.buildChildView(a, b, d);
                this.proxyChildEvents(f), this._isShown && e.triggerMethodOn(f, "before:show"), 
                this.children.add(f), this.renderChildView(f, -1), this._isShown && e.triggerMethodOn(f, "show");
            },
            ...
            addChild: function(a, b, d) {
                ...
                return this._updateIndices(f, !0, d), this._addChildView(f, d), f;
            },
            ...
            _addChildView: function(a, b) {
                this.proxyChildEvents(a), this.triggerMethod("before:add:child", a), this.children.add(a), 
                this.renderChildView(a, b), this._isShown && !this.isBuffering && e.triggerMethodOn(a, "show"), 
            ...
            removeChildView: function(a) {
                ...
                this.stopListening(a), this.children.remove(a), this.triggerMethod("remove:child", a), 
            ...
            destroy: function() {
                ...
                this.destroyChildren(), this.triggerMethod("destroy:collection"), e.View.prototype.destroy.apply(this, arguments));
            },
            ...
            proxyChildEvents: function(a) {
                ...
                this.listenTo(a, "all", function() {
                    var d = f.call(arguments), e = d[0], g = this.normalizeMethods(c.result(this, "childEvents"));
                    d[0] = b + ":" + e, d.splice(1, 0, a), "undefined" != typeof g && c.isFunction(g[e]) && g[e].apply(this, d.slice(1)), 
            ...
            _renderChildren: function() {
                this.isRendered && e.CollectionView.prototype._renderChildren.call(this);
            },
            _renderTemplate: function() {
                var a = {};
                a = this.serializeData(), a = this.mixinTemplateHelpers(a), this.triggerMethod("before:render:template");
                var b = this.getTemplate(), c = e.Renderer.render(b, a, this);
            ...
            getChildViewContainer: function(a) {
                ...
                if (d) {
                    var f = c.isFunction(d) ? d.call(a) : d;
                    if (b = "@" === f.charAt(0) && a.ui ? a.ui[f.substr(4)] : a.$(f), b.length <= 0) throw new e.Error({
            ...
            constructor: function(a) {
                a = a || {}, this._firstRender = !0, this._initializeRegions(a), e.ItemView.call(this, a);
            },
            render: function() {
                return this._ensureViewIsIntact(), this._firstRender ? this._firstRender = !1 : this._reInitializeRegions(), 
                e.ItemView.prototype.render.apply(this, arguments);
            },
            destroy: function() {
                return this.isDestroyed ? this : (this.regionManager.destroy(), e.ItemView.prototype.destroy.apply(this, arguments));
            },
            addRegion: function(a, b) {
                this.triggerMethod("before:region:add", a);
                var c = {};
            ...
            removeRegion: function(a) {
                return this.triggerMethod("before:region:remove", a), delete this.regions[a], this.regionManager.removeRegion(a);
            },
            ...
            _initializeRegions: function(a) {
                ...
                c.isFunction(d) && (d = d.call(this, a)), c.extend(b, d), b = this.normalizeUIValues(b), 
                this.addRegions(b);
            },
            _reInitializeRegions: function() {
                this.regionManager.emptyRegions(), this.regionManager.each(function(a) {
                    a.reset();
                });
            },
            ...
            _initRegionManager: function() {
                this.regionManager = this.getRegionManager(), this.listenTo(this.regionManager, "before:add:region", function(a) {
            ...
            function c(b, c) {
                this.view = c, this.defaults = a.result(this, "defaults") || {}, this.options = a.extend({}, this.defaults, b), 
                this.$ = function() {
            ...
            var e = {
                ...
                behaviorEvents: function(c, d) {
                    ...
                    return b.each(d, function(c, d) {
                        var g = {}, h = b.clone(b.result(c, "events")) || {}, i = b.result(c, "ui"), j = b.extend({}, f, i);
                        h = a.normalizeUIKeys(h, j), b.each(b.keys(h), function(a) {
                            var e = new Array(d + 2).join(" "), f = a + e, i = b.isFunction(h[a]) ? h[a] : c[h[a]];
                            g[f] = b.bind(i, c);
                        }), e = b.extend(e, g);
                    }), e;
                }
            ...
            constructor: function(a) {
                b.Router.apply(this, arguments), this.options = a || {};
            ...
            _addAppRoute: function(a, b, d) {
                var f = a[d];
                if (!f) throw new e.Error('Method "' + d + '" was not found on the controller');
                this.route(b, d, c.bind(f, a));
            },
            getOption: e.proxyGetOption
        }), e.Application = function(a) {
            this.options = a, this._initializeRegions(a), this._initCallbacks = new e.Callbacks(), 
            this.submodules = {}, c.extend(this, a), this._initChannel(), this.initialize.apply(this, arguments);
            ...
            _initializeRegions: function(a) {
                ...
                var d = e.getOption(a, "regions");
                return c.isFunction(d) && (d = d.call(this, a)), c.extend(b, d), this.addRegions(b), 
                this;
            },
            _initRegionManager: function() {
                this._regionManager = this.getRegionManager(), this.listenTo(this._regionManager, "before:add:region", function(a) {
                    this.triggerMethod("before:add:region", a);
                }), this.listenTo(this._regionManager, "add:region", function(a, b) {
                    this[a] = b, this.triggerMethod("add:region", a, b);
                }), this.listenTo(this._regionManager, "before:remove:region", function(a) {
                    this.triggerMethod("before:remove:region", a);
                }), this.listenTo(this._regionManager, "remove:region", function(a, b) {
                    delete this[a], this.triggerMethod("remove:region", a, b);
                });
            },
            ...
            _runModuleDefinition: function(a, d) {
                if (a) {
                    var f = c.flatten([ this, this.app, b, e, b.$, c, d ]);
                    a.apply(this, f);
                }
            },
            ...
            _getStartWithParent: function(a, b) {
                var d;
                return c.isFunction(a) && a.prototype instanceof e.Module ? (d = b.constructor.prototype.startWithParent, 
    ...
    define("app", [ "marionette" ], function(Marionette) {
        ...
        app.addInitializer(function() {
            Date.prototype.getMinDoubleDigits = function() {
                ...
                return 10 > cMin ? "0" + cMin.toString() : cMin.toString();
            };
        });
        return app;
    });
    ...
    define("text!templates/content-layout.html", function() {
        return function(obj) {
            var __p = [];
            with (obj || {}) __p.push('<div class="contentLayout-one"></div><div class="contentLayout-two"></div>');
            return __p.join("");
        };
    });
    define("text!templates/nestedRegions-layout.html", function() {
        return function(obj) {
            var __p = [];
            with (obj || {}) __p.push('<div class="regionOne-first"><span>Layout <strong>RegionOneNested - first</strong></span></div><div class="regionOne-second"><span>Layout <strong>RegionOneNested</strong></span></div>');
            return __p.join("");
        };
    });
    define("views/NestedRegionsLayout", [ "app", "marionette", "text!templates/nestedRegions-layout.html" ], function(app, Marionette, nestedRegionsTemplate) {
    ...
    define("views/ContentLayout", [ "app", "marionette", "text!templates/content-layout.html", "views/NestedRegionsLayout" ], function(app, Marionette, contentLayoutTemplate, NestedRegionsLayout) {
        return Marionette.LayoutView.extend({
    ...
    define("controllers/controller", [ "app", "marionette", "views/ContentLayout", "views/NestedRegionsLayout" ], function(app, Marionette, ContentLayout) {
    ...
    require([ "app", "underscore", "backbone", "marionette", "routers/router", "controllers/controller" ], function(app, _, Backbone, Marionette, Router, Controller) {
        app.start();
